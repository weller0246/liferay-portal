...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {notificationTemplate(notificationTemplateId: ___){actions, dateCreated, dateModified, enable, id, name}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
