...
page import="com.liferay.sync.web.internal.display.context.DevicesManagementToolbarDisplayContext" %><%@
page import="com.liferay.sync.web.internal.display.context.SitesManagementToolbarDisplayContext" %>
