...
<liferay-util:html-top>
	<link href="<%= PortalUtil.getStaticResourceURL(request, PortalUtil.getPathProxy() + application.getContextPath() + "/css/management_bar.css") %>" rel="stylesheet" type="text/css" />
</liferay-util:html-top>