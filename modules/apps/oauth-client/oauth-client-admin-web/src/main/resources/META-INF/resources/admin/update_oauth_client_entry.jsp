	...
	>
		<div class="sheet">
			<aui:fieldset>
				...
				<aui:input helpMessage="oauth-client-oidc-user-info-mapper-json-help" label="oauth-client-oidc-user-info-mapper-json" name="oidcUserInfoMapperJSON" style="min-height: 400px;" type="hidden" value="<%= OAuthClientEntryConstants.DEFAULT_OIDC_USER_INFO_MAPPER_JSON %>" />
