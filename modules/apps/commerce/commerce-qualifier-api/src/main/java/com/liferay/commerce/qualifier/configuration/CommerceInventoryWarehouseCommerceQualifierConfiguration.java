...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.CommerceInventoryWarehouseCommerceQualifierConfiguration",
	localization = "content/Language",
	name = "commerce-inventory-warehouse-commerce-qualifier-configuration-name"
)
public interface CommerceInventoryWarehouseCommerceQualifierConfiguration
