...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.AccountGroupCommerceQualifierConfiguration",
	localization = "content/Language",
	name = "account-group-commerce-qualifier-configuration-name"
)
public interface AccountGroupCommerceQualifierConfiguration
