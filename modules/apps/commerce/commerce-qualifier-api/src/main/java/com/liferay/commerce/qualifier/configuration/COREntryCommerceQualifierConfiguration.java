...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.COREntryCommerceQualifierConfiguration",
	localization = "content/Language",
	name = "commerce-order-rule-commerce-qualifier-configuration-name"
)
public interface COREntryCommerceQualifierConfiguration
