...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.AccountEntryCommerceQualifierConfiguration",
	localization = "content/Language",
	name = "account-entry-commerce-qualifier-configuration-name"
)
public interface AccountEntryCommerceQualifierConfiguration
