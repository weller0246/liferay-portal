...
@Meta.OCD(
	id = "com.liferay.commerce.qualifier.configuration.CommerceTermEntryCommerceQualifierConfiguration",
	localization = "content/Language",
	name = "commerce-term-entry-commerce-qualifier-configuration-name"
)
public interface CommerceTermEntryCommerceQualifierConfiguration
