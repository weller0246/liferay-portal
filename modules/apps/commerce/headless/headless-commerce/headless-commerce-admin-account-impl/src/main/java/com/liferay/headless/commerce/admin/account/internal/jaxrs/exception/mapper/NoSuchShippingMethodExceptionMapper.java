...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Account.NoSuchShippingMethodExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class NoSuchShippingMethodExceptionMapper
	extends BaseExceptionMapper<NoSuchShippingMethodException> {
