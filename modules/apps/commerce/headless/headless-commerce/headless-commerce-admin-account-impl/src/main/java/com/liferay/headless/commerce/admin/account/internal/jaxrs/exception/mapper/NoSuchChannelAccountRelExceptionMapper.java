...
@Component(
	property = {
		...
		"osgi.jaxrs.name=Liferay.Headless.Commerce.Admin.Account.NoSuchChannelAccountRelExceptionMapper"
	},
	service = ExceptionMapper.class
)
@Provider
public class NoSuchChannelAccountRelExceptionMapper
	extends BaseExceptionMapper<NoSuchChannelAccountEntryRelException> {

	@Override
	public String getErrorDescription() {
		return "Channel account relation not found";
	}
