...
public abstract class BaseSuggestionResourceImpl
	implements EntityModelResource, SuggestionResource,
			   VulcanBatchEngineTaskItemDelegate<Suggestion> {
	...
	public void create(
			java.util.Collection<Suggestion> suggestions,
	...
	public void setContextBatchUnsafeConsumer(
		UnsafeBiConsumer
			<java.util.Collection<Suggestion>,
			 UnsafeConsumer<Suggestion, Exception>, Exception>
