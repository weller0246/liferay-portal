		...
		<aui:fieldset id='<%= liferayPortletResponse.getNamespace() + "additionalEmailAddresses" %>'>
			...
			%>
				...
				<div class="form-group-autofit lfr-form-row">
					...
					<div class="form-group-item">
						<aui:select inlineField="<%= true %>" label="type" listType="<%= className + ListTypeConstants.EMAIL_ADDRESS %>" listTypeFieldName="typeId" name='<%= "emailAddressTypeId" + emailAddressesIndex %>' />
					</div>
