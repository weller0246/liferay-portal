...
import com.liferay.notification.admin.model.NotificationTemplateTable;
import com.liferay.notification.admin.model.impl.NotificationTemplateImpl;
import com.liferay.notification.admin.model.impl.NotificationTemplateModelImpl;
import com.liferay.notification.admin.service.persistence.NotificationTemplatePersistence;
import com.liferay.notification.admin.service.persistence.NotificationTemplateUtil;
...
public class NotificationTemplatePersistenceImpl
	...
	public NotificationTemplate findByUUID_G(String uuid, long groupId)
		...
		NotificationTemplate notificationTemplate = fetchByUUID_G(
			uuid, groupId);
	...
	public NotificationTemplate fetchByUUID_G(
		...
		if (result instanceof NotificationTemplate) {
			...
			if (!Objects.equals(uuid, notificationTemplate.getUuid()) ||
	...
	public NotificationTemplate removeByUUID_G(String uuid, long groupId)
		...
		NotificationTemplate notificationTemplate = findByUUID_G(uuid, groupId);
	 ...
	 */
	@Override
	public List<NotificationTemplate> findByGroupId(long groupId) {
	 ...
	 */
	@Override
	public List<NotificationTemplate> findByGroupId(
	...
	public NotificationTemplate findByGroupId_First(
		...
		NotificationTemplate notificationTemplate = fetchByGroupId_First(
	...
	public NotificationTemplate fetchByGroupId_First(
		...
		List<NotificationTemplate> list = findByGroupId(
	...
	public NotificationTemplate findByGroupId_Last(
		...
		NotificationTemplate notificationTemplate = fetchByGroupId_Last(
			groupId, orderByComparator);
	...
	public NotificationTemplate[] findByGroupId_PrevAndNext(
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, notificationTemplate, groupId, orderByComparator,
				true);
	...
	protected NotificationTemplate getByGroupId_PrevAndNext(
	 ...
	 */
	@Override
	public List<NotificationTemplate> findByG_E(long groupId, boolean enabled) {
		return findByG_E(
	 ...
	 */
	@Override
	public List<NotificationTemplate> findByG_E(
	...
	public NotificationTemplate findByG_E_First(
		...
		NotificationTemplate notificationTemplate = fetchByG_E_First(
	...
	public NotificationTemplate fetchByG_E_First(
		...
		List<NotificationTemplate> list = findByG_E(
	...
	public NotificationTemplate findByG_E_Last(
		...
		NotificationTemplate notificationTemplate = fetchByG_E_Last(
			groupId, enabled, orderByComparator);
	...
	public NotificationTemplate[] findByG_E_PrevAndNext(
		...
		try {
			...
			array[0] = getByG_E_PrevAndNext(
				session, notificationTemplate, groupId, enabled,
				orderByComparator, true);
	...
	protected NotificationTemplate getByG_E_PrevAndNext(
		Session session, NotificationTemplate notificationTemplate,
		long groupId, boolean enabled,
		OrderByComparator<NotificationTemplate> orderByComparator,
		boolean previous) {
	...
	protected void cacheUniqueFindersCache(
		...
		Object[] args = new Object[] {
			notificationTemplateModelImpl.getUuid(),
			notificationTemplateModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(
			_finderPathFetchByUUID_G, args, notificationTemplateModelImpl);
	}
