...
import com.liferay.notification.admin.exception.NoSuchNotificationQueueEntryException;
import com.liferay.notification.admin.model.NotificationQueueEntry;
import com.liferay.notification.admin.model.NotificationQueueEntryTable;
import com.liferay.notification.admin.model.impl.NotificationQueueEntryImpl;
import com.liferay.notification.admin.model.impl.NotificationQueueEntryModelImpl;
import com.liferay.notification.admin.service.persistence.NotificationQueueEntryPersistence;
import com.liferay.notification.admin.service.persistence.NotificationQueueEntryUtil;
import com.liferay.notification.admin.service.persistence.impl.constants.NotificationPersistenceConstants;
...
public class NotificationQueueEntryPersistenceImpl
	...
	/**
	 * Returns all the notification queue entries where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @return the matching notification queue entries
	 */
	@Override
	public List<NotificationQueueEntry> findByGroupId(long groupId) {
		return findByGroupId(
			groupId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the notification queue entries where groupId = &#63;.
	 *
	 * <p>
	 ...
	 */
	@Override
	public List<NotificationQueueEntry> findByGroupId(
	...
	/**
	 * Returns an ordered range of all the notification queue entries where groupId = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>NotificationQueueEntryModelImpl</code>.
	 * </p>
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (NotificationQueueEntry notificationQueueEntry : list) {
					if (groupId != notificationQueueEntry.getGroupId()) {
						list = null;
	...
	/**
	 * Returns the first notification queue entry in the ordered set where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public NotificationQueueEntry findByGroupId_First(
			long groupId,
			OrderByComparator<NotificationQueueEntry> orderByComparator)
		throws NoSuchNotificationQueueEntryException {

		NotificationQueueEntry notificationQueueEntry = fetchByGroupId_First(
	 ...
	 */
	@Override
	public NotificationQueueEntry fetchByGroupId_First(
		long groupId,
		OrderByComparator<NotificationQueueEntry> orderByComparator) {

		List<NotificationQueueEntry> list = findByGroupId(
	...
	/**
	 * Returns the last notification queue entry in the ordered set where groupId = &#63;.
	 *
	 * @param groupId the group ID
	 * @param orderByComparator the comparator to order the set by (optionally <code>null</code>)
	 ...
	 */
	@Override
	public NotificationQueueEntry findByGroupId_Last(
			long groupId,
			OrderByComparator<NotificationQueueEntry> orderByComparator)
		throws NoSuchNotificationQueueEntryException {

		NotificationQueueEntry notificationQueueEntry = fetchByGroupId_Last(
			groupId, orderByComparator);
	 ...
	 */
	@Override
	public NotificationQueueEntry fetchByGroupId_Last(
		long groupId,
		OrderByComparator<NotificationQueueEntry> orderByComparator) {
	...
	/**
	 * Returns the notification queue entries before and after the current notification queue entry in the ordered set where groupId = &#63;.
	 *
	 ...
	 */
	@Override
	public NotificationQueueEntry[] findByGroupId_PrevAndNext(
			long notificationQueueEntryId, long groupId,
			OrderByComparator<NotificationQueueEntry> orderByComparator)
		throws NoSuchNotificationQueueEntryException {
		...
		try {
			...
			array[0] = getByGroupId_PrevAndNext(
				session, notificationQueueEntry, groupId, orderByComparator,
				true);
	...
	protected NotificationQueueEntry getByGroupId_PrevAndNext(
	...
	/**
	 * Removes all the notification queue entries where groupId = &#63; from the database.
	 *
	 * @param groupId the group ID
	 */
	@Override
	...
	/**
	 * Returns the number of notification queue entries where groupId = &#63;.
	 *
	 * @param groupId the group ID
	...
	private static final String _FINDER_COLUMN_GROUPID_GROUPID_2 =
		"notificationQueueEntry.groupId = ?";
	...
	/**
	 * Returns all the notification queue entries where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63;.
	 *
	 * @param groupId the group ID
	 ...
	 */
	@Override
	public List<NotificationQueueEntry> findByG_C_C_S(
	...
	/**
	 * Returns a range of all the notification queue entries where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>NotificationQueueEntryModelImpl</code>.
	 * </p>
	...
	/**
	 * Returns an ordered range of all the notification queue entries where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>NotificationQueueEntryModelImpl</code>.
	 * </p>
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (NotificationQueueEntry notificationQueueEntry : list) {
					if ((groupId != notificationQueueEntry.getGroupId()) ||
						(classNameId !=
							notificationQueueEntry.getClassNameId()) ||
						(classPK != notificationQueueEntry.getClassPK()) ||
						(sent != notificationQueueEntry.isSent())) {
	...
	/**
	 * Returns the first notification queue entry in the ordered set where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public NotificationQueueEntry findByG_C_C_S_First(
			long groupId, long classNameId, long classPK, boolean sent,
			OrderByComparator<NotificationQueueEntry> orderByComparator)
		throws NoSuchNotificationQueueEntryException {

		NotificationQueueEntry notificationQueueEntry = fetchByG_C_C_S_First(
	 ...
	 */
	@Override
	public NotificationQueueEntry fetchByG_C_C_S_First(
		long groupId, long classNameId, long classPK, boolean sent,
		OrderByComparator<NotificationQueueEntry> orderByComparator) {

		List<NotificationQueueEntry> list = findByG_C_C_S(
	...
	/**
	 * Returns the last notification queue entry in the ordered set where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	 ...
	 */
	@Override
	public NotificationQueueEntry findByG_C_C_S_Last(
			long groupId, long classNameId, long classPK, boolean sent,
			OrderByComparator<NotificationQueueEntry> orderByComparator)
		throws NoSuchNotificationQueueEntryException {

		NotificationQueueEntry notificationQueueEntry = fetchByG_C_C_S_Last(
			groupId, classNameId, classPK, sent, orderByComparator);
	 ...
	 */
	@Override
	public NotificationQueueEntry fetchByG_C_C_S_Last(
		long groupId, long classNameId, long classPK, boolean sent,
		OrderByComparator<NotificationQueueEntry> orderByComparator) {
	...
	/**
	 * Returns the notification queue entries before and after the current notification queue entry in the ordered set where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63;.
	 *
	 * @param notificationQueueEntryId the primary key of the current notification queue entry
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 ...
	 */
	@Override
	public NotificationQueueEntry[] findByG_C_C_S_PrevAndNext(
			long notificationQueueEntryId, long groupId, long classNameId,
		...
		try {
			...
			array[0] = getByG_C_C_S_PrevAndNext(
				session, notificationQueueEntry, groupId, classNameId, classPK,
	...
	protected NotificationQueueEntry getByG_C_C_S_PrevAndNext(
		Session session, NotificationQueueEntry notificationQueueEntry,
		long groupId, long classNameId, long classPK, boolean sent,
		OrderByComparator<NotificationQueueEntry> orderByComparator,
		boolean previous) {
	...
	/**
	 * Removes all the notification queue entries where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63; from the database.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
	...
	/**
	 * Returns the number of notification queue entries where groupId = &#63; and classNameId = &#63; and classPK = &#63; and sent = &#63;.
	 *
	 * @param groupId the group ID
	 * @param classNameId the class name ID
	 * @param classPK the class pk
