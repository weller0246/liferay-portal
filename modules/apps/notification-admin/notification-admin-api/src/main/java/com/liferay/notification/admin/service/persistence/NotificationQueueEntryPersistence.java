...
public interface NotificationQueueEntryPersistence
	 ...
	 */
	public java.util.List<NotificationQueueEntry> findByGroupId(long groupId);
	 ...
	 */
	public java.util.List<NotificationQueueEntry> findByGroupId(
	 ...
	 * @return the matching notification queue entries
	 */
	public java.util.List<NotificationQueueEntry> findByG_C_C_S(
