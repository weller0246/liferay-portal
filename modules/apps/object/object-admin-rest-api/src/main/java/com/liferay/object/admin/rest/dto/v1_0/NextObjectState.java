 ...
 */
@Generated("")
@GraphQLName("NextObjectState")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "NextObjectState")
public class NextObjectState implements Serializable {

	public static NextObjectState toDTO(String json) {
		return ObjectMapperUtil.readValue(NextObjectState.class, json);
	}

	public static NextObjectState unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(NextObjectState.class, json);
	}
	...
	@Schema(
		...
		defaultValue = "com.liferay.object.admin.rest.dto.v1_0.NextObjectState",
		name = "x-class-name"
	)
