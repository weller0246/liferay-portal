...
import com.liferay.object.internal.model.listener.ObjectEntryModelListener;
...
public class ObjectActionDownloadTriggerMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) {
		...
		String objectEntry = message.getString("objectEntry");

		String objectDefinition = message.getString("objectDefinition");
		...
		_objectActionEngine.executeObjectActions(
			objectDefinition1.getClassName(), companyId,
			ObjectActionTriggerConstants.KEY_ON_AFTER_ATTACHMENT_DOWNLOAD,
			_getPayloadJSONObject(
				ObjectActionTriggerConstants.KEY_ON_AFTER_ATTACHMENT_DOWNLOAD, null, _objectEntryLocalService.fetchObjectEntry(objectEntry, objectDefinition1.getObjectDefinitionId()),
				userId), userId);
	}
