...
/**
 * Provides the base implementation for the notifications queue entry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.notifications.admin.service.impl.NotificationsQueueEntryLocalServiceImpl}.
 * </p>
 *
 * @author Gabriel Albuquerque
 * @see com.liferay.notifications.admin.service.impl.NotificationsQueueEntryLocalServiceImpl
 * @generated
 */
public abstract class NotificationsQueueEntryLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>NotificationsQueueEntryLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>NotificationsQueueEntryLocalServiceUtil</code>.
	 */
	...
	public NotificationsQueueEntry createNotificationsQueueEntry(
		...
		return notificationsQueueEntryPersistence.create(
	...
	public NotificationsQueueEntry deleteNotificationsQueueEntry(
		...
		return notificationsQueueEntryPersistence.remove(
			notificationsQueueEntryId);
	}
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return notificationsQueueEntryPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			NotificationsQueueEntry.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return notificationsQueueEntryPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return notificationsQueueEntryPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	public NotificationsQueueEntry fetchNotificationsQueueEntry(
		...
		return notificationsQueueEntryPersistence.fetchByPrimaryKey(
			notificationsQueueEntryId);
	}
	...
	public NotificationsQueueEntry getNotificationsQueueEntry(
		...
		return notificationsQueueEntryPersistence.findByPrimaryKey(
			notificationsQueueEntryId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(NotificationsQueueEntry.class);
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return notificationsQueueEntryLocalService.
			deleteNotificationsQueueEntry(
				(NotificationsQueueEntry)persistedModel);
	}

	@Override
	public BasePersistence<NotificationsQueueEntry> getBasePersistence() {
		return notificationsQueueEntryPersistence;
	}
	...
	public List<NotificationsQueueEntry> getNotificationsQueueEntries(
		...
		return notificationsQueueEntryPersistence.findAll(start, end);
	}
	...
	public int getNotificationsQueueEntriesCount() {
		return notificationsQueueEntryPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			NotificationsQueueEntryLocalService.class,
	...
	public void setAopProxy(Object aopProxy) {
		notificationsQueueEntryLocalService =
			(NotificationsQueueEntryLocalService)aopProxy;

		_setLocalServiceUtilService(notificationsQueueEntryLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return NotificationsQueueEntryLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field =
				NotificationsQueueEntryLocalServiceUtil.class.getDeclaredField(
					"_service");

			field.setAccessible(true);

			field.set(null, notificationsQueueEntryLocalService);
		}
	...
	protected NotificationsQueueEntryLocalService
		notificationsQueueEntryLocalService;
