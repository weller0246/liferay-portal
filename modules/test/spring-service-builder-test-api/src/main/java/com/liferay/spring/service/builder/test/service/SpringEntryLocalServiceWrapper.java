...
public class SpringEntryLocalServiceWrapper
	 ...
	 */
	@Override
	public com.liferay.spring.service.builder.test.model.SpringEntry
		addSpringEntry(
			com.liferay.spring.service.builder.test.model.SpringEntry
				springEntry) {
	...
	public java.util.List
		<com.liferay.spring.service.builder.test.model.SpringEntry>
			getSpringEntries(int start, int end) {
