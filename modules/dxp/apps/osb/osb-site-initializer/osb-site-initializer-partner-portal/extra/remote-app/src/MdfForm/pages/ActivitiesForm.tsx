...
const GoalsPage: any = ({
	...
	const leadFollowStrategy = useGetListTypeDefinitions(
	...
	const optionsExpense = [
		...
		{
			key: 'Sponsorship Fee 1',
			name: 'Sponsorship Fee 1',
		},
	];
						...
						<div className="border-0 mt-5 shadow-lg sheet sheet-lg">
							<div>
								<div className="mb-4 sheet-header">
									...
									<h2>Insurance Industry Lead Gen</h2>
								...
								<div className="form-group-autofit">
									<div className="form-group-item">
										<InputText
											...
											type="text"
											value={
												formik.values.activityDesription
											}
										/>
									</div>
								</div>
								...
								<div className="form-group-autofit">
									<div className="form-group-item">
										<InputText
											...
											type="text"
											value={
												formik.values.activityPromotion
											}
										/>
									</div>
								</div>
								...
								<div className="mb-4 sheet-header">
									...
									<h6 className="text-secondary">
										Add all the expenses that best match
										with your Activity to add your Total MDF
										REQUESTED amount
									</h6>
								</div>
								...
								<div className="mb-4">
									<h6 className="text-secondary">
										Silver Partner can request up to 50% of
								...
								<div className="form-group-autofit">
									<div className="form-group-item">
										<label>
											Is a lead list an outcome of this
											activity
										</label>
								...
								<div className="form-group-autofit">
									<div className="form-group-item">
										<InputText
											...
											type="text"
											value={formik.values.targetLeads}
										/>
									</div>
								</div>
								...
								<div className="form-group-autofit">
									<div className="form-group-item">
										<label>
											Lead Follow Up strategy (select all
											that apply)
										</label>
								...
								<div className="mb-1">
									<div className="form-group-item">
										<InputText
											...
											placeholder=""
											type="text"
											value={formik.values.detailsOnLead}
										/>
									</div>
								</div>
								...
								<div className="mb-4">
									<h6 className="text-secondary">
										(i) Please describe the follow-up plan
										in detail: Do you need any assets from
										Liferay (i.e. landing page, collateral,
										content) Will Liferay participate in the
										follow up? If so, please provide details
									</h6>
								</div>
							</div>
